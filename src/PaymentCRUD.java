...
public class PaymentCRUD extends JFrame {
    ...
    void populateTable() {
        try {
            ...
            String[] colNames = {"Payment ID", "Status", "Method", "Order ID"};
            ...
            while (res.next()) {
                ...
                String[] row = {payId, status, method, orderId };
                model.addRow(row);
            }
    ...
    public PaymentCRUD() {
       ...
       paymentTable.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                methodField.setText(model.getValueAt(row, 2).toString());
        ...
        updateButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (response == JOptionPane.YES_OPTION) {
                    try {
                        PreparedStatement ps = con.prepareStatement("UPDATE pembayaran SET status=?, metode=?, pesanan_ID=? WHERE pembayaran_ID=?");
